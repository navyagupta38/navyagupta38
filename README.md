...
## 🔹 Technical Skills
- **Languages & Tools**: Python | JavaScript | HTML | CSS | SQL | PL/SQL | Git | Bootstrap  
- **Frameworks**: Django | Machine Learning (Scikit-learn, Pandas, NumPy)  
- **Domains**: Data Analysis | Generative AI | Web Development  
...
### 📌 [Melody_Gem](https://github.com/navyagupta38/Melody-Gen)  
Generative AI project for **melody creation**.  
- 🎶 Uses LSTM, RNN, Transformer models with Music21  
- 🎹 Generates original melodies with deep learning  

---

### 📌 [Gen-Music](https://github.com/navyagupta38/Gen-music)  
